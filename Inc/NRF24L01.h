...
//NRF2401片选信号
#define Clr_NRF24L01_RX_CE      HAL_GPIO_WritePin(SPI1_CE_GPIO_Port, SPI1_CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CE      HAL_GPIO_WritePin(SPI1_CE_GPIO_Port, SPI1_CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_RX_CSN     HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CSN     HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(SPI1_IRQ_GPIO_Port, SPI1_IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(SPI1_IRQ_GPIO_Port, SPI1_IRQ_Pin, GPIO_PIN_SET) 

#define READ_NRF24L01_RX_IRQ    HAL_GPIO_ReadPin(SPI1_IRQ_GPIO_Port, SPI1_IRQ_Pin) 


//NRF2401片选信号
#define Clr_NRF24L01_TX_CE      HAL_GPIO_WritePin(SPI2_CE_GPIO_Port, SPI2_CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CE      HAL_GPIO_WritePin(SPI2_CE_GPIO_Port, SPI2_CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_TX_CSN     HAL_GPIO_WritePin(SPI2_NSS_GPIO_Port, SPI2_NSS_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CSN     HAL_GPIO_WritePin(SPI2_NSS_GPIO_Port, SPI2_NSS_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(SPI2_IRQ_GPIO_Port, SPI2_IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(SPI2_IRQ_GPIO_Port, SPI2_IRQ_Pin, GPIO_PIN_SET) 
